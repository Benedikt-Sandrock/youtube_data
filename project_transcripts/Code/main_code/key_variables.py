...
final_end_date = datetime(2023, 10, 7)
#period of analysis
published_after_analysis = "2022-10-07T00:00:00Z"
published_before_analysis = "2025-10-07T00:00:00Z"

query = "Konflikt Palästina Israel"
query_list = ["Konflikt Israel Palästina", "Konflikt Palästina Israel", "Israel Palästina", "Palästina Israel"]

#query_list = ["Nahostkonflikt", "Gaza-Krieg", "Israel Palästina Konflikt", "Palästina Israel Konflikt"] #schon durchgelaufen monatsweise

###
# Palästina und Israel als einzelne Suchbegriffe verwenden? Gibt es dann mehr Kanäle?
###
