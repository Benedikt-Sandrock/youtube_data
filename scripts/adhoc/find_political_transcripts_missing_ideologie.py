...
Transkriptinhalt), die aber noch NICHT mit dem IDEOLOGIE_I-Prompt
...
Nutzung: unten ggf. PROMPT_ID/SOURCE anpassen, dann:
    PYTHONPATH=src PYTHONIOENCODING=utf-8 .venv/Scripts/python.exe \
      scripts/adhoc/find_political_transcripts_missing_ideologie.py

Schreibt eine CSV mit den Spalten video_id, channel_id nach
scripts/adhoc/output/political_transcripts_missing_ideologie.csv.
"""
